...
class _MultiSearchViewState extends State<MultiSearchView>
      ...
      children: [
                                  ...
                                  ? ((snapshot.data?.isNotEmpty ?? false)
                                      ? (snapshot.data
                                          ...
                                          ?.map((e) => SearchWidget(
                                                ...
                                                /// to call Searchable Widget ///
                                                data: Searchable(

                                                    /// data: = to add data to Searchable items ///
        ...
        Container(
          ...
          child: GestureDetector(
            onTap: () {
              /// to control with animation of text field ///
              _iconAnimationController.forward();

              /// code to open or close textfield when click icon search or cancel ///
  ...
  /// update list when the user click the keyboard search button
  ...
  /// hide the TextField by scrolling  the end
